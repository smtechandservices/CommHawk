...
const Hero = () => {
    return (
        <section className="min-h-[85vh] flex flex-col items-center justify-center relative pt-[100px] md:pt-[120px] pb-[40px] md:pb-[0px] overflow-hidden px-6 md:px-[30px]">
            <div className="px-2 md:px-6 w-full grid grid-cols-1 lg:grid-cols-2 items-center gap-16 z-10">
                <div className="text-left">
                    ...
                    <motion.p
                        className="text-lg leading-relaxed text-white/80 mb-12 font-normal max-w-xl"
                        initial={{ opacity: 0, y: 30 }}
                        animate={{ opacity: 1, y: 0 }}
            ...
            <motion.div
                className="mt-2 opacity-20 hidden md:block"
                initial={{ opacity: 0 }}
                animate={{ opacity: 0.2 }}
